...
//----------------------------------------------------------------------------------------std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const& std::string const&
...
public:
	...
	static std::string trimStart(std::string source, const std::string &trimChars = L" \t\n\r\v\f")
	{
		return source.erase(0, source.find_first_not_of(trimChars));
	}

	static std::string trimEnd(std::string source, const std::string &trimChars = L" \t\n\r\v\f")
	{
		return source.erase(source.find_last_not_of(trimChars) + 1);
	}

	static std::string trim(std::string source, const std::string &trimChars = L" \t\n\r\v\f")
	{
	...
	static std::vector<std::string> split(const std::string &source, wchar_t delimiter)
	{
	...
	static std::string wstring_to_string(const std::string &wstr)
	{
		return std::string_convert<std::codecvt_utf8<wchar_t>, wchar_t>().to_bytes(wstr);
	}
};
