...
namespace APL
{
    ...
    class Indexer final : public std::enable_shared_from_this<Indexer>, public std::vector<std::vector<int>>
    //NOTE(fernando)
    // , public Iterator<std::vector<int>>
    {
  private:
  ...
  public:
      ...
      static int fromShapeChk(std::vector<int> &sh, std::vector<int> &pos, std::shared_ptr<APL::types::Callable> blame);
      static int fromShapeChk(std::vector<int> &sh, std::shared_ptr<APL::types::Value> pos, int IO, std::shared_ptr<APL::types::Callable> blame);
  ...
  public:
      static std::shared_ptr<PosSh> poss(std::shared_ptr<APL::types::Value> v, std::vector<int> &ish, int IO, std::shared_ptr<APL::types::Callable> blame);

      static std::vector<int> intsNoIO(std::shared_ptr<APL::types::Value> v, int IO);
