...
const std::vector<int> Rank0Arr::SHAPE = std::vector<int>(0);
    ...
    Rank0Arr::Rank0Arr(std::shared_ptr<APL::types::Value> item) : Arr(SHAPE, 1, 0), item(item)
    {
    }
    ...
    std::shared_ptr<APL::types::Value> Rank0Arr::get(int i)
    {
      return item;
    }

    std::string Rank0Arr::asString()
    {
    ...
    std::shared_ptr<APL::types::Value> Rank0Arr::prototype()
    {
      return item->prototype();
    }

    std::shared_ptr<APL::types::Value> Rank0Arr::safePrototype()
    {
      return item->safePrototype();
    }

    std::shared_ptr<APL::types::Value> Rank0Arr::ofShape(std::vector<int> &sh)
    {
      return SingleItemArr::maybe(item, sh);
    }

    std::vector<std::shared_ptr<APL::types::Value>> Rank0Arr::valuesCopy()
    {
