...
const std::vector<int> Shape1Arr::SHAPE = std::vector<int>{1};
    ...
    Shape1Arr::Shape1Arr(std::shared_ptr<APL::types::Value> item) : Arr(SHAPE, 1, 1), item(item)
    {
    }
    ...
    std::shared_ptr<APL::types::Value> Shape1Arr::get(int i)
    {
      return item;
    }

    std::string Shape1Arr::asString()
    {
    ...
    std::shared_ptr<APL::types::Value> Shape1Arr::prototype()
    {
      return item->prototype();
    }

    std::shared_ptr<APL::types::Value> Shape1Arr::safePrototype()
    {
      return item->safePrototype();
    }

    std::shared_ptr<APL::types::Value> Shape1Arr::ofShape(std::vector<int> &sh)
    {
      return SingleItemArr::maybe(item, sh);
    }

    std::vector<std::shared_ptr<APL::types::Value>> Shape1Arr::valuesCopy()
    {
      return std::vector<std::shared_ptr<APL::types::Value>>{item};
    }
