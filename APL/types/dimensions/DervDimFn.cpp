...
//JAVA TO C++ CONVERTER TODO TASK: You cannot use 'shared_from_this' in a constructor:
    ...
    std::shared_ptr<APL::types::Value> DervDimFn::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w)
    {
    ...
    std::shared_ptr<APL::types::Value> DervDimFn::call(std::shared_ptr<APL::types::Value> w)
    {
