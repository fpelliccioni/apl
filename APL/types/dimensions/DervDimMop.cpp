...
namespace APL::types::dimensions
{
	...
	std::shared_ptr<Value> DervDimMop::call(std::shared_ptr<Obj> aa, std::shared_ptr<Value> a, std::shared_ptr<Value> w, std::shared_ptr<DerivedMop> derv)
	{
	...
	std::shared_ptr<Value> DervDimMop::call(std::shared_ptr<Obj> aa, std::shared_ptr<Value> w, std::shared_ptr<DerivedMop> derv)
	{
