...
namespace APL::types::functions::userDefined
{
  ...
  public:
      ...
      std::shared_ptr<APL::types::Obj> callObj(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Obj> ww, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedDop> derv) override;
      ...
      std::shared_ptr<APL::types::Obj> callObj(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Obj> ww, std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedDop> derv) override;
