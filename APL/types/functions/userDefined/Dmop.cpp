...
namespace APL::types::functions::userDefined
{
    ...
    std::shared_ptr<APL::types::Value> Dmop::call(std::shared_ptr<APL::types::Obj> f, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedMop> derv)
    {
    ...
    std::shared_ptr<APL::types::Obj> Dmop::callObj(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedMop> derv)
    {
    ...
    std::shared_ptr<APL::types::Value> Dmop::call(std::shared_ptr<APL::types::Obj> f, std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedMop> derv)
    {
      std::shared_ptr<APL::types::Obj> o = callObj(f, a, w, derv);
      if (std::dynamic_pointer_cast<APL::types::Value>(o) != nullptr)
      {
          return std::static_pointer_cast<APL::types::Value>(o);
      }
    ...
    std::shared_ptr<APL::types::Obj> Dmop::callObj(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedMop> derv)
    {
