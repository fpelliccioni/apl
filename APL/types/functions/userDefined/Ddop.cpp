...
namespace APL::types::functions::userDefined
{
    ...
    std::shared_ptr<APL::types::Value> Ddop::call(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Obj> ww, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedDop> derv)
    {
      std::shared_ptr<APL::types::Obj> o = callObj(aa, ww, w, derv);
    ...
    std::shared_ptr<APL::types::Obj> Ddop::callObj(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Obj> ww, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedDop> derv)
    {
    ...
    std::shared_ptr<APL::types::Value> Ddop::call(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Obj> ww, std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedDop> derv)
    {
      std::shared_ptr<APL::types::Obj> o = callObj(aa, ww, a, w, derv);
      if (std::dynamic_pointer_cast<APL::types::Value>(o) != nullptr)
      {
          return std::static_pointer_cast<APL::types::Value>(o);
      }
    ...
    std::shared_ptr<APL::types::Obj> Ddop::callObj(std::shared_ptr<APL::types::Obj> aa, std::shared_ptr<APL::types::Obj> ww, std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedDop> derv)
    {
