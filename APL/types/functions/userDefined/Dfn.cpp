...
namespace APL::types::functions::userDefined
{
	...
	std::shared_ptr<Value> Dfn::call(std::shared_ptr<Value> w)
	{
	...
	std::shared_ptr<Obj> Dfn::callObj(std::shared_ptr<Value> w)
	{
	...
	std::shared_ptr<Value> Dfn::call(std::shared_ptr<Value> a, std::shared_ptr<Value> w)
	{
	...
	std::shared_ptr<Obj> Dfn::callObj(std::shared_ptr<Value> a, std::shared_ptr<Value> w)
	{
	...
	std::wstring Dfn::repr()
	{
	  return code->toRepr();
	}

	std::wstring Dfn::name()
	{
		return L"dfn";
	}
}
