...
namespace APL::types::functions::builtins::dops
{
	...
	class JotDiaeresisBuiltin : public Dop
	{
  public:
	...
	protected:
		std::shared_ptr<JotDiaeresisBuiltin> shared_from_this()
		{
			return std::static_pointer_cast<JotDiaeresisBuiltin>(Dop::shared_from_this());
		}
	};
}
