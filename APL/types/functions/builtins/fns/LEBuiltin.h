...
namespace APL::types::functions::builtins::fns
{
	...
	class LEBuiltin : public Builtin
	{
  public:
  ...
  public:
	...
	protected:
		std::shared_ptr<LEBuiltin> shared_from_this()
		{
			return std::static_pointer_cast<LEBuiltin>(APL::types::functions::Builtin::shared_from_this());
		}
	};
}
