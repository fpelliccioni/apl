...
namespace APL::types::functions::builtins::fns
{
	...
	std::shared_ptr<APL::types::Value> RShoeBuiltin::call(std::shared_ptr<APL::types::Value> w)
	{
	...
	std::shared_ptr<APL::types::Value> RShoeBuiltin::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w)
	{
	...
	std::shared_ptr<APL::types::Obj> RShoeBuiltin::callObj(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w)
	{
	...
	std::shared_ptr<APL::types::Value> RShoeBuiltin::under(std::shared_ptr<APL::types::Obj> o, std::shared_ptr<APL::types::Value> w)
	{
	  std::vector<std::shared_ptr<APL::types::Value>> vs = w->valuesCopy();
	  vs[0] = std::dynamic_pointer_cast<Fun>(o) != nullptr? (std::static_pointer_cast<Fun>(o))->call(call(w)) : std::static_pointer_cast<APL::types::Value>(o);
	  return Arr::createL(vs, w->shape);
	}

	std::shared_ptr<APL::types::Value> RShoeBuiltin::underW(std::shared_ptr<APL::types::Obj> o, std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w)
	{
	...
	void RShoeBuiltin::replace(std::vector<std::shared_ptr<APL::types::Value>> &vs, std::shared_ptr<APL::types::Value> w, std::vector<int> &d, int i)
	{
	  int c = d[i] - sc->IO;
	  if (i + 1 == d.size())
	  {
	  ...
	  {
		std::shared_ptr<APL::types::Value> cv = vs[c];
		std::vector<std::shared_ptr<APL::types::Value>> vsN = cv->valuesCopy();
		replace(vsN, w, d, i + 1);
