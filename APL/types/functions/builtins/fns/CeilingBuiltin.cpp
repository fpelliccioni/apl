...
namespace APL::types::functions::builtins::fns
{
    ...
    std::string CeilingBuiltin::repr()
    {
      return L"⌈";
    }

    std::shared_ptr<APL::types::Value> CeilingBuiltin::identity()
    {
      return Num::NEGINF;
    }
...
const std::shared_ptr<NumMV> CeilingBuiltin::NF = std::make_shared<NumMVAnonymousInnerClass>();
    ...
    std::shared_ptr<APL::types::Value> CeilingBuiltin::NumMVAnonymousInnerClass::call(std::shared_ptr<Num> w)
    {
      return w->ceil();
    }
    ...
    std::shared_ptr<APL::types::Value> CeilingBuiltin::call(std::shared_ptr<APL::types::Value> w)
    {
...
const std::shared_ptr<D_NNeN> CeilingBuiltin::DNF = std::make_shared<D_NNeNAnonymousInnerClass>();
    ...
    std::shared_ptr<APL::types::Value> CeilingBuiltin::D_NNeNAnonymousInnerClass::call(std::shared_ptr<APL::types::BigValue> a, std::shared_ptr<APL::types::BigValue> w)
    {
      return a->compareTo(w) > 0? a : w;
    }

    std::shared_ptr<APL::types::Value> CeilingBuiltin::call(std::shared_ptr<APL::types::Value> a0, std::shared_ptr<APL::types::Value> w0)
    {
