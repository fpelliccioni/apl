...
namespace APL::types::functions::builtins::mops
{
  ...
  public:
      ...
      std::shared_ptr<APL::types::Value> call(std::shared_ptr<APL::types::Obj> f, std::shared_ptr<APL::types::Value> w, int dim) override;
  ...
  private:
      std::shared_ptr<APL::types::Value> ngnReduce(std::shared_ptr<APL::types::Value> x, int axis, std::shared_ptr<Fun> f);
