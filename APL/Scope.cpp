...
#include <APL/types/arrs/APL::types::arrs::BitArr copy 2.h>
#include <APL/types/arrs/APL::types::arrs::BitArr copy.h>
...
namespace APL {
    ...
    std::string Scope::FunAnonymousInnerClass::repr() {
        return L"";
    }

    std::shared_ptr<APL::types::Value> Scope::FunAnonymousInnerClass::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::string Scope::FunAnonymousInnerClass2::repr() {
        return L"";
    }

    std::shared_ptr<APL::types::Value> Scope::FunAnonymousInnerClass2::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::string Scope::FunAnonymousInnerClass3::repr() {
        return L"";
    }

    std::shared_ptr<APL::types::Value> Scope::FunAnonymousInnerClass3::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::string Scope::FunAnonymousInnerClass4::repr() {
        return L"";
    }

    std::shared_ptr<APL::types::Value> Scope::FunAnonymousInnerClass4::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::shared_ptr<Scope> Scope::owner(std::string const& name) {
    ...
    void Scope::update(std::string const& name, std::shared_ptr<APL::types::Obj> val) {
    ...
    void Scope::set(std::string const& name, std::shared_ptr<APL::types::Obj> val) {
      if (name[0] == L'⎕') {
...
//ORIGINAL LINE: case "⎕IO":
        if (name == L"⎕IO") {
            int tIO = (std::static_pointer_cast<APL::types::Value>(val))->asInt();
            if (tIO != 0 && tIO != 1) {
...
//ORIGINAL LINE: case "⎕BOXSIMPLE":
            ...
            Main::enclosePrimitives = (std::static_pointer_cast<APL::types::Value>(val))->asInt() == 1;
        }
...
//ORIGINAL LINE: case "⎕RL":
            ...
            rnd = std::make_shared<Random>((std::static_pointer_cast<APL::types::Value>(val))->asInt());
        }
//ORIGINAL LINE: case "⎕PP":
        else if (name == L"⎕PP") {
            if (std::dynamic_pointer_cast<Primitive>(val) != nullptr) {
              Num::setPrecision((std::static_pointer_cast<APL::types::Value>(val))->asInt());
            } else {
              std::vector<int> args = (std::static_pointer_cast<APL::types::Value>(val))->asIntVec();
              if (args.size() == 3) {
    ...
    std::shared_ptr<APL::types::Obj> Scope::get(std::string const& name) {
...
//ORIGINAL LINE: case "⎕OPT":
      ...
      std::shared_ptr<APL::types::Obj> f = vars[name];
      if (f == nullptr) {
        if (parent == nullptr) {
            return nullptr;
        } else {
    ...
    std::string Scope::BuiltinAnonymousInnerClass::repr() {
        return L"⎕U";
    }

    std::shared_ptr<APL::types::Value> Scope::BuiltinAnonymousInnerClass::call(std::shared_ptr<APL::types::Value> w) {
      outerInstance->sys->ucmd(w->asString());
      return nullptr;
    }

    std::shared_ptr<Variable> Scope::getVar(std::string const& name) {
    ...
    std::string Scope::toString(std::string const& prep) {
      std::shared_ptr<StringBuilder> res = std::make_shared<StringBuilder>(L"{\n");
      std::string cp = prep + L"  ";
      for (auto n : vars) {
...
//JAVA TO C++ CONVERTER TODO TASK: There is no C++ equivalent to 'toString':
    ...
    std::shared_ptr<APL::types::Value> Scope::GCLog::call(std::shared_ptr<APL::types::Value> w) {
//JAVA TO C++ CONVERTER TODO TASK: There is no C++ equivalent to 'toString':
      return std::make_shared<Logger>(sc, w->toString());
    }

    Scope::GCLog::Logger::Logger(std::shared_ptr<Scope> sc, std::string const& s) : msg(s), sc(sc) {
    }
...
//JAVA TO C++ CONVERTER WARNING: There is no equivalent in C++ to finalizer methods:
    ...
    std::string Scope::GCLog::Logger::toString() {
      return L"⎕GCLOG[" + msg + L"]";
    }

    std::shared_ptr<APL::types::Value> Scope::GCLog::Logger::ofShape(std::vector<int> &sh) {
      return SingleItemArr::maybe(shared_from_this(), sh);
    }

    std::string Scope::Timer::repr() {
      return L"⎕TIME";
    }
    ...
    std::shared_ptr<APL::types::Value> Scope::Timer::call(std::shared_ptr<APL::types::Value> w) {
      return call(Num::ONE, w);
    }

    std::shared_ptr<APL::types::Value> Scope::Timer::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
      ...
      std::shared_ptr<APL::tokenizer::types::BasicLines> testTokenized = Tokenizer::tokenize(test);
    ...
    std::shared_ptr<APL::types::Value> Scope::Eraser::call(std::shared_ptr<APL::types::Value> w) {
      sc->set(w->asString(), nullptr);
      return w;
    }

    std::string Scope::Delay::repr() {
      return L"⎕DL";
    }
    ...
    std::shared_ptr<APL::types::Value> Scope::Delay::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::shared_ptr<APL::types::Value> Scope::UCS::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::shared_ptr<APL::types::Value> Scope::UCS::NumMVAnonymousInnerClass::call(std::shared_ptr<Num> c) {
    ...
    std::shared_ptr<APL::types::Value> Scope::UCS::callInv(std::shared_ptr<APL::types::Value> w) {
      return call(w);
    }

    std::string Scope::MapGen::repr() {
      return L"⎕MAP";
    }

    std::shared_ptr<APL::types::Value> Scope::MapGen::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::shared_ptr<APL::types::Value> Scope::MapGen::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
      if (a->rank != 1) {
    ...
    std::string Scope::Optimizer::repr() {
      return L"⎕OPT";
    }
    ...
    std::shared_ptr<APL::types::Value> Scope::Optimizer::call(std::shared_ptr<APL::types::Value> w) {
      std::string name = w->asString();
      if (!(std::dynamic_pointer_cast<APL::types::Value>(outerInstance->get(name)) != nullptr)) {
          return Num::MINUS_ONE;
      }
      std::shared_ptr<APL::types::Value> v = std::static_pointer_cast<APL::types::Value>(outerInstance->get(name));
      std::shared_ptr<APL::types::Value> optimized = v->squeeze();
      if (v == optimized) {
          return Num::ZERO;
      }
    ...
    std::string Scope::ClassGetter::repr() {
      return L"⎕CLASS";
    }

    std::shared_ptr<APL::types::Value> Scope::ClassGetter::call(std::shared_ptr<APL::types::Value> w) {
      return std::make_shared<APL::types::arrs::ChrArr>(w->getClass().getCanonicalName());
    }

    std::string Scope::Ex::repr() {
      return L"⎕EX";
    }
    ...
    std::shared_ptr<APL::types::Value> Scope::Ex::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::shared_ptr<APL::types::Obj> Scope::Ex::callObj(std::shared_ptr<APL::types::Value> w) {
      std::string path = w->asString();
      return Main::exec(Main::readFile(path), sc);
    }

    std::string Scope::Lns::repr() {
      return L"⎕LNS";
    }

    std::shared_ptr<APL::types::Value> Scope::Lns::call(std::shared_ptr<APL::types::Value> w) {
      std::string path = w->asString();
      std::vector<std::string> a = Main::readFile(path).split(L"\n");
      std::vector<std::shared_ptr<APL::types::Value>> o(a.size());
    ...
    std::string Scope::Lns::get(std::shared_ptr<APLMap> m, std::string const& key, std::string const& def) {
      std::shared_ptr<APL::types::Value> got = std::static_pointer_cast<APL::types::Value>(m->getRaw(key));
      if (got != Null::NULL) {
          return got->asString();
      }
      return def;
    ...
    std::shared_ptr<APL::types::Value> Scope::Lns::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
      if (std::dynamic_pointer_cast<APLMap>(a) != nullptr) {
        try {
          ...
          std::string content = get(m, L"content", L"");
...
//JAVA TO C++ CONVERTER TODO TASK: There is no C++ equivalent to 'toString':
          ...
          std::shared_ptr<APL::types::Obj> eo = m->getRaw(L"e");
          if (eo != Null::NULL) {
            std::shared_ptr<APLMap> e = std::static_pointer_cast<APLMap>(eo);
            for (auto k : e->allKeys()) {
              std::shared_ptr<APL::types::Value> v = std::static_pointer_cast<APL::types::Value>(e->getRaw(k));
              conn->setRequestProperty(k->asString(), v->asString());
            }
          }

          std::shared_ptr<APL::types::Obj> cache = m->getRaw(L"cache");
...
//ORIGINAL LINE: try (PrintWriter pw = new PrintWriter(p))
    ...
    std::string Scope::Shell::repr() {
      return L"⎕SH";
    }

    std::shared_ptr<APL::types::Value> Scope::Shell::call(std::shared_ptr<APL::types::Value> w) {
      return exec(w, nullptr, std::vector<signed char>(), false);
    }

    std::shared_ptr<APL::types::Value> Scope::Shell::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
      std::shared_ptr<APLMap> m = std::static_pointer_cast<APLMap>(a);

      std::shared_ptr<File> dir = nullptr;
      std::shared_ptr<APL::types::Obj> diro = m->getRaw(L"dir");
      if (diro != Null::NULL) {
          dir = std::make_shared<File>((std::static_pointer_cast<APL::types::Value>(diro))->asString());
      }

      std::vector<signed char> inp;
      std::shared_ptr<APL::types::Obj> inpo = m->getRaw(L"inp");
      if (inpo != Null::NULL) {
        std::shared_ptr<APL::types::Value> inpv = std::static_pointer_cast<APL::types::Value>(inpo);
        if (inpv->ia > 0) {
      ...
      bool raw = false;
      std::shared_ptr<APL::types::Obj> rawo = m->getRaw(L"raw");
      if (rawo != Null::NULL) {
    ...
    std::shared_ptr<APL::types::Value> Scope::Shell::exec(std::shared_ptr<APL::types::Value> w, std::shared_ptr<File> f, std::vector<signed char> &inp, bool raw) {
      try {
        std::shared_ptr<Process> p;
        if (std::dynamic_pointer_cast<Char>(w[0]) != nullptr) {
          std::string cmd = w->asString();
          p = Runtime::getRuntime().exec(cmd, std::vector<std::string>(0), f);
        } else {
          std::vector<std::string> parts(w->ia);
          for (int i = 0; i < parts.size(); i++) {
            parts[i] = w[i].asString();
          }
          p = Runtime::getRuntime().exec(parts, std::vector<std::string>(0), f);
        }
        if (!inp.empty()) {
        ...
        if (raw) {
            return std::make_shared<HArr>(std::vector<std::shared_ptr<APL::types::Value>>{ret, std::make_shared<DoubleArr>(out), std::make_shared<DoubleArr>(err)});
        } else {
            return std::make_shared<HArr>(std::vector<std::shared_ptr<APL::types::Value>>{ret, Main::toAPL(std::string(out, StandardCharsets::UTF_8)), Main::toAPL(std::string(err, StandardCharsets::UTF_8))});
        }
    ...
    std::string Scope::NC::repr() {
      return L"⎕NC";
    }

    std::shared_ptr<APL::types::Value> Scope::NC::call(std::shared_ptr<APL::types::Value> w) {
      std::shared_ptr<APL::types::Obj> obj = outerInstance->get(w->asString());
      if (obj == nullptr) {
          return Num::ZERO;
      }
      if (std::dynamic_pointer_cast<APL::types::Value>(obj) != nullptr) {
          return Num::NUMS[2];
      }
    ...
    std::string Scope::Hasher::repr() {
      return L"⎕HASH";
    }

    std::shared_ptr<APL::types::Value> Scope::Hasher::call(std::shared_ptr<APL::types::Value> w) {
      return Num::of(w->hashCode());
    }

    std::string Scope::Stdin::repr() {
      return L"⎕STDIN";
    }

    std::shared_ptr<APL::types::Value> Scope::Stdin::call(std::shared_ptr<APL::types::Value> w) {
...
const std::unordered_map<std::string, std::shared_ptr<Pr>> Scope::Profiler::pfRes = std::unordered_map<std::string, std::shared_ptr<Pr>>();

    std::shared_ptr<APL::types::Obj> Scope::Profiler::results() {
      std::vector<std::shared_ptr<APL::types::Value>> arr(pfRes.size() * 4 + 4);
      arr[0] = std::make_shared<APL::types::arrs::ChrArr>(L"expr");
      arr[1] = std::make_shared<APL::types::arrs::ChrArr>(L"calls");
      arr[2] = std::make_shared<APL::types::arrs::ChrArr>(L"total ms");
      arr[3] = std::make_shared<APL::types::arrs::ChrArr>(L"avg ms");
    ...
    std::string Scope::Profiler::repr() {
      return L"⎕PFX";
    }

    std::shared_ptr<APL::types::Value> Scope::Profiler::call(std::shared_ptr<APL::types::Value> w) {
      return call(w, w);
    }

    std::shared_ptr<APL::types::Value> Scope::Profiler::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
    ...
    std::shared_ptr<Pr> Scope::Profiler::get(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
      std::string s = w->asString();
    ...
    std::shared_ptr<APL::types::Obj> Scope::Profiler::callObj(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
      std::shared_ptr<Pr> p = get(a, w);
      std::shared_ptr<APL::tokenizer::types::BasicLines> t = p->tok;
      long long sns = System::nanoTime();
      std::shared_ptr<APL::types::Obj> res = Main::execLines(t, sc);
    ...
    std::shared_ptr<Pr> Scope::Profiler::ProfilerOp::get(std::shared_ptr<APL::types::Obj> f) {
      std::string s = (std::static_pointer_cast<APL::types::Value>(f))->asString();
    ...
    std::shared_ptr<APL::types::Value> Scope::Profiler::ProfilerOp::call(std::shared_ptr<APL::types::Obj> f, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedMop> derv) {
      std::shared_ptr<Pr> p = get(f);

      long long sns = System::nanoTime();
      std::shared_ptr<APL::types::Value> r = p->fn->call(w);
      long long ens = System::nanoTime();
      p->ms += (ens - sns) / 1000000.0;
      return r;
    }

    std::shared_ptr<APL::types::Value> Scope::Profiler::ProfilerOp::call(std::shared_ptr<APL::types::Obj> f, std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w, std::shared_ptr<DerivedMop> derv) {
      std::shared_ptr<Pr> p = get(f);

      long long sns = System::nanoTime();
      std::shared_ptr<APL::types::Value> r = p->fn->call(a, w);
      long long ens = System::nanoTime();
      p->ms += (ens - sns) / 1000000.0;
      return r;
    }

    std::string Scope::Profiler::ProfilerOp::repr() {
      return L"⎕PFO";
    }

    Scope::Pr::Pr(std::shared_ptr<APL::tokenizer::types::BasicLines> tok) : tok(tok) {
    }

    std::shared_ptr<APL::types::Value> Scope::Big::call(std::shared_ptr<APL::types::Value> w) {
      return rec(w);
    }

    std::shared_ptr<APL::types::Value> Scope::Big::rec(std::shared_ptr<APL::types::Value> w) {
      if (std::dynamic_pointer_cast<Num>(w) != nullptr) {
          return std::make_shared<APL::types::BigValue>((std::static_pointer_cast<Num>(w))->num);
      }
      if (std::dynamic_pointer_cast<Primitive>(w) != nullptr) {
          return w;
      }
      std::vector<std::shared_ptr<APL::types::Value>> pa = w->values();
      std::vector<std::shared_ptr<APL::types::Value>> va(pa.size());
    ...
    std::shared_ptr<APL::types::Value> Scope::Big::callInv(std::shared_ptr<APL::types::Value> w) {
      return recN(w);
    }

    std::shared_ptr<APL::types::Value> Scope::Big::recN(std::shared_ptr<APL::types::Value> w) {
      if (std::dynamic_pointer_cast<APL::types::BigValue>(w) != nullptr) {
          return (std::static_pointer_cast<APL::types::BigValue>(w))->num();
      }
      if (std::dynamic_pointer_cast<Primitive>(w) != nullptr) {
          return w;
      }
    ...
    std::string Scope::Big::repr() {
      return L"⎕BIG";
    }

    std::shared_ptr<APL::types::Value> Scope::DR::call(std::shared_ptr<APL::types::Value> w) {
    ...
    std::shared_ptr<APL::types::Value> Scope::DR::call(std::shared_ptr<APL::types::Value> a, std::shared_ptr<APL::types::Value> w) {
      ...
      if ((f == 1 || f == 3 || f == 5) && (t == 1 || t == 3 || t == 5) && (f == 3 ^ t == 3)) {
        // if (w instanceof Num) return new APL::types::BigValue(Double.doubleToLongBits(w.asDouble()), false);
        // return new Num(Double.longBitsToDouble(((APL::types::BigValue) w).i.longValue()));
        if (t == 3) {
          if (f == 1) {
      ...
      throw APL::errors::NYIError(a + L"⎕DR not implemented", shared_from_this());
    }
    APL::types::Value callInvW(APL::types::Value a, APL::types::Value w) {
