...
public class Num extends Primitive {
  ...
  public static std::string format(double d) {
    double a = Math.abs(d);
    if (d == 0) {
    ...
    */
    if (exp < sEr || exp > eEr) { // scientific notation
      ...
      return new std::string(buf, 0, len);
    }
  ...
  public static std::string formatInt(int i) {
