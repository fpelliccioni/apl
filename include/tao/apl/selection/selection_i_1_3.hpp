...
#ifndef TAO_ALGORITHM_SELECTION_SELECTION_I_1_3_HPP_
#define TAO_ALGORITHM_SELECTION_SELECTION_I_1_3_HPP_
...
template <TotallyOrdered T, TotallyOrdered U, TotallyOrdered V>
    requires(Same<T, U, V>)
inline constexpr
...
template <TotallyOrdered T, TotallyOrdered U, TotallyOrdered V, TotallyOrdered W>
    requires(Same<T, U, V, W>)
inline constexpr
...
#endif /*TAO_ALGORITHM_SELECTION_SELECTION_I_1_3_HPP_*/
